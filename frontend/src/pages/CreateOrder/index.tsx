...
export function CreateOrder() {
  ...
  const handleCreateOrder = async (e: FormEvent) => {
    ...
    if (!customerId || cart.length === 0) {
      setError('Selecione um cliente e adicione pelo menos um item ao carrinho');
      return;
    }
  ...
  return (
    <div className="orders-page">
      ...
      <div className="create-order-card">
        ...
        <div style={{ marginBottom: '1.5rem', paddingBottom: '1.5rem', borderBottom: '2px solid #eee' }}>
          <label htmlFor="customer_id" style={{ display: 'none' }}>Cliente</label>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <strong style={{ margin: 0, fontSize: '1rem', fontWeight: '600', color: '#333' }}>Cliente:</strong>
            <select
              id="customer_id"
              value={customerId}
            ...
            >
              ...
              {customers
                .filter((customer) => customer.id !== user?.customer_id)
                .map((customer) => (
                    ...
                    <div className="cart-controls">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (inputValue === '') {
                            return; // Allow empty field temporarily during typing
                          }
        ...
        <div className="cart-summary">
          ...
          <button 
            ...
            disabled={creating || !customerId || cart.length === 0}
            style={{ marginBottom: 0, textDecoration: 'none', cursor: creating || !customerId || cart.length === 0 ? 'not-allowed' : 'pointer' }}
          >
